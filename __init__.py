...
class TimerSkill(MycroftSkill):
    ...
    def initialize(self):
        ...
        self.widget_api = GUIWidgets(bus=self.bus)
    ...
    def _show_gui_page(self):
        """Show the gui page only once and not on every update"""
        self.log.info("timerCalledDisplayOnlyOnce")
    ...
    def _update_gui(self):
        ...
        timers_to_display = self._select_timers_to_display(display_max=10)
